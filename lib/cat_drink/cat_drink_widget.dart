...
import 'cat_drink_model.dart';
export 'cat_drink_model.dart';

class CatDrinkWidget extends StatefulWidget {
  const CatDrinkWidget({Key? key}) : super(key: key);

  @override
  _CatDrinkWidgetState createState() => _CatDrinkWidgetState();
}

class _CatDrinkWidgetState extends State<CatDrinkWidget> {
  late CatDrinkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CatDrinkModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> catDrinkCartRecordList = snapshot.data!;
        final catDrinkCartRecord = catDrinkCartRecordList.isNotEmpty
            ? catDrinkCartRecordList.first
            : null;
