        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'AdminArea',
              path: 'adminArea',
              builder: (context, params) => AdminAreaWidget(),
            ),
            FFRoute(
              name: 'editUser',
              path: 'editUser',
              asyncParams: {
                'userEdit': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => EditUserWidget(
                userEdit: params.getParam('userEdit', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'AdminProducts',
            ...
            FFRoute(
              name: 'menuNoRegisterUsers',
              path: 'menuNoRegisterUsers',
              builder: (context, params) => MenuNoRegisterUsersWidget(),
            ),
            FFRoute(
              name: 'editProduct',
              path: 'editProduct',
              asyncParams: {
                'editProduct': getDoc(['items'], ItemsRecord.fromSnapshot),
              },
