...
import 'bt_create_product_model.dart';
export 'bt_create_product_model.dart';

class BtCreateProductWidget extends StatefulWidget {
  const BtCreateProductWidget({Key? key}) : super(key: key);

  @override
  _BtCreateProductWidgetState createState() => _BtCreateProductWidgetState();
}

class _BtCreateProductWidgetState extends State<BtCreateProductWidget> {
  late BtCreateProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtCreateProductModel());
