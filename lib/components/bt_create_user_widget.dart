...
import 'bt_create_user_model.dart';
export 'bt_create_user_model.dart';

class BtCreateUserWidget extends StatefulWidget {
  const BtCreateUserWidget({Key? key}) : super(key: key);

  @override
  _BtCreateUserWidgetState createState() => _BtCreateUserWidgetState();
}

class _BtCreateUserWidgetState extends State<BtCreateUserWidget> {
  late BtCreateUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtCreateUserModel());
    ...
    _model.txtDirectionController ??= TextEditingController();
    _model.txtDirectionFocusNode ??= FocusNode();
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: TextFormField(
                            controller: _model.txtDirectionController,
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await actions.createUser(
                            ...
                            _model.txtDirectionController.text,
