...
export 'admin_area_model.dart';

class AdminAreaWidget extends StatefulWidget {
  const AdminAreaWidget({Key? key}) : super(key: key);

  @override
  _AdminAreaWidgetState createState() => _AdminAreaWidgetState();
}

class _AdminAreaWidgetState extends State<AdminAreaWidget> {
  late AdminAreaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAreaModel());
  }
