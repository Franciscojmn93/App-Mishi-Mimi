...
import 'schema/selectd_items_record.dart';
import 'schema/order_record.dart';
import 'schema/cart_record.dart';
import 'schema/logos_record.dart';
...
export 'schema/selectd_items_record.dart';
export 'schema/order_record.dart';
export 'schema/cart_record.dart';
export 'schema/logos_record.dart';
...
/// Functions to query SelectdItemsRecords (as a Stream and as a Future).
Future<int> querySelectdItemsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SelectdItemsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SelectdItemsRecord>> querySelectdItemsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SelectdItemsRecord.collection,
      SelectdItemsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SelectdItemsRecord>> querySelectdItemsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query LogosRecords (as a Stream and as a Future).
Future<int> queryLogosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      LogosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<LogosRecord>> queryLogosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      LogosRecord.collection,
      LogosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<LogosRecord>> queryLogosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
