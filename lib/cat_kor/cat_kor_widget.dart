...
import 'cat_kor_model.dart';
export 'cat_kor_model.dart';

class CatKorWidget extends StatefulWidget {
  const CatKorWidget({Key? key}) : super(key: key);

  @override
  _CatKorWidgetState createState() => _CatKorWidgetState();
}

class _CatKorWidgetState extends State<CatKorWidget> {
  late CatKorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CatKorModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartRecord> catKorCartRecordList = snapshot.data!;
        final catKorCartRecord =
            catKorCartRecordList.isNotEmpty ? catKorCartRecordList.first : null;
